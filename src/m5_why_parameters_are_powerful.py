...
def main():
    ...
    # better_draw_circles(rg.Point(20, 75), 5)
    # better_draw_circles(rg.Point(200, -50), 10)
    even_better_draw_circles(rg.Point(250, -100), 15, 10, 'red', 5)
    even_better_draw_circles(rg.Point(-150, 100), 20, 15, 'blue', 10)
    even_better_draw_circles(rg.Point(-50, 210), 5, 50, 'purple', 2)
    even_better_draw_circles(rg.Point(150, 50), 25, 10, 'green', 8)
...
def even_better_draw_circles(point, rad, num, col, thick):
